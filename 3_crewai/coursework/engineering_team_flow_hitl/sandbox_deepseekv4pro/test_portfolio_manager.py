...
class TestTransactions(unittest.TestCase):
    ...
    def test_get_transactions_filtered_by_time_range(self) -> None:
        ...
        # Use transactions created in setUp (initial deposit) plus new ones
...
# ======================================================================
#
# NOTE: renamed from TestSharePriceProvider to TestSharePriceProviderClass
# to avoid shadowing the imported TestSharePriceProvider class from
# portfolio_manager.
